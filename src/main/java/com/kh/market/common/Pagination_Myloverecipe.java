...
public class Pagination_Myloverecipe {
	// PageInfo 객체를 리턴하는 static 메소드
	public static MypageloverecipePageInfo getPageInfo(int currentPage,int listCount) {
		
		// 페이지 정보를 담아줄 PageInfo 참조변수 선언
		MypageloverecipePageInfo pi = null;
		...
		pi = new MypageloverecipePageInfo(currentPage,listCount,pageLimit
