        ...
        <c:if test="${ !empty sessionScope.loginUser }">
                    ...
                    <tbody class="item">
                        <tr>
                            ...
                            <c:url var="adminrecipewritedetail" value="adminsuggestwriteDetail">
								<c:param name="rb_num" value="${r.rb_num}"/>
							</c:url>
                            <td class="tdtext" style="padding-left: 30px;" onclick="location.href='${adminrecipewritedetail}'">${ r.rb_title }</td>
                            <td>${ r.rb_writer }</td>
                            <td>${ r.rb_date }</td>
                            <td>${ r.rb_count }</td>
                            <td>${ r.rb_thank }</td>
                ...
                <div class="pagination">
                	...
                	<c:if test="${ rpi.currentPage eq 1}">
                		...
                		<c:if test="${ rpi.currentPage ne 1 }">
                			<c:url var="before" value="adminrecipeSuggest">
					...
					<c:if test="${ p ne rpi.currentPage }">
						<c:url var="pagination" value="adminrecipeSuggest">
