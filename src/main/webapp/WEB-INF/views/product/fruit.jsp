    ...
    <div class="topTenRecipe">
        <div class="TOP">
            <div class="TOP10" style="width: 1100px; display: flex; margin: 0 auto; ">
                <div class="topImgdiv"><img src="resources/img/fruit.png" class="topImg"></div>
        ...
        <ul class="mList">
            ...
            <li class="m1" data-tab="tab2"><a>국산과일</a></li>
            <li class="m1" data-tab="tab3"><a>수입과일</a></li>
            <li class="m1" data-tab="tab4"><a>냉동/건과일</a></li>
        </ul>
    </div>
    <!-- 단일상품 타이틀 end-->
