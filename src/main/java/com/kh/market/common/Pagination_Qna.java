...
public class Pagination_Qna {
	public static ServiceCenterQnaPageInfo getPageInfo(int currentPage,int listCount) {
		
		// 페이지 정보를 담아줄 PageInfo 참조변수 선언
		ServiceCenterQnaPageInfo pi = null;
		...
		pi = new ServiceCenterQnaPageInfo(currentPage,listCount,pageLimit
