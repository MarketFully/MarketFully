    ...
    <div class="topTenRecipe">
        <div class="TOP">
            <div class="TOP10" style="width: 1100px; display: flex; margin: 0 auto; ">
                <div class="topImgdiv"><img src="resources/img/fish.png" class="topImg"></div>
        ...
        <ul class="mList">
            ...
            <li class="m1" data-tab="tab2"><a>생선류</a></li>
            <li class="m1" data-tab="tab3"><a>오징어/낙지/문어</a></li>
            <li class="m1" data-tab="tab4"><a>새우/게/랍스터</a></li>
            <li class="m1" data-tab="tab5"><a>해산물/조개류</a></li>
            <li class="m1" data-tab="tab6"><a>수산가공품</a></li>
            <li class="m1" data-tab="tab7"><a>김/미역/해조류</a></li>
            <li class="m1" data-tab="tab8"><a>건어물/다시백</a></li>
        </ul>
    </div>
    <!-- 단일상품 타이틀 end-->
