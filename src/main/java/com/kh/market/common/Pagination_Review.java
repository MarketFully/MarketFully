...
public class Pagination_Review {
	// PageInfo 객체를 리턴하는 static 메소드
	public static ProductReviewPageInfo getPageInfo(int currentPage,int listCount) {
		
		// 페이지 정보를 담아줄 PageInfo 참조변수 선언
		ProductReviewPageInfo pi = null;
		...
		int boardLimit = 7;		// 한 페이지에 보여질 게시글 갯수
		...
		pi = new ProductReviewPageInfo(currentPage,listCount,pageLimit
