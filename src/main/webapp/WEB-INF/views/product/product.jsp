...
<body>
   ...
   <%@include file="../common/header.jsp" %>
    ...
    <!-- 단일상품 타이틀 end-->
     ...
     <!-- 상품 -->
     <!-- 고기 -->
     <div class="product_title" onclick="location.href='Productmeet'">
      ...
      <div class="product_title" onclick="location.href='Productfruit'">
        <img src="resources/img/fruit.png" style="width: 30px; height: 30px; margin-right: 10px;"></img> 
        과일
        <img src="resources/img/arrow.png" style="width: 7px; height: 8px; margin-top: 8px; margin-left: 20px;">
        </div>
      ...
      <!-- 채소 -->
      <div class="product_title" onclick="location.href='Productvegetable'">
        <img src="resources/img/vegetable.png" style="width: 30px; height: 30px; margin-right: 10px;"></img> 
        채소
        <img src="resources/img/arrow.png" style="width: 7px; height: 8px; margin-top: 8px; margin-left: 20px;">
        </div>
      ...
      <div class="product_title" onclick="location.href='source'">
        <img src="resources/img/sauce.png" style="width: 30px; height: 30px; margin-right: 10px;"></img> 
        면 / 양념 / 오일
        <img src="resources/img/arrow.png" style="width: 7px; height: 8px; margin-top: 8px; margin-left: 20px;">
        </div>
      ...
      <div class="product_title" onclick="location.href='Productfish'">
        <img src="resources/img/fish.png" style="width: 30px; height: 30px; margin-right: 10px;"></img> 
        수산 / 해산 / 건어물
        <img src="resources/img/arrow.png" style="width: 7px; height: 8px; margin-top: 8px; margin-left: 20px;">
        </div>
      ...
      <div class="product_title" onclick="location.href='Productmilk'">
        <img src="resources/img/milk.png" style="width: 30px; height: 30px; margin-right: 10px;"></img> 
        가공식품
        <img src="resources/img/arrow.png" style="width: 7px; height: 8px; margin-top: 8px; margin-left: 20px;">
        </div>
