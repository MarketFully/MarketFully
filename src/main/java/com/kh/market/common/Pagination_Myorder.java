...
public class Pagination_Myorder {
	// PageInfo 객체를 리턴하는 static 메소드
	public static MypageOrderPageInfo getPageInfo(int currentPage,int listCount) {
		
		// 페이지 정보를 담아줄 PageInfo 참조변수 선언
		MypageOrderPageInfo pi = null;
		...
		pi = new MypageOrderPageInfo(currentPage,listCount,pageLimit
